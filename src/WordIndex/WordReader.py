...
######################
    ...
    def addFileName(self, filename, readNow=False):
        ...
        @type filename: string of a filename
        @param readNow: set to True to add the words from the given file
                        immediately to the reader
        @type readNow: boolean
        """
    ...
    def addFileNames(self, filenames, readNow=False):
        ...
        @param filenames: filenames to be added
        @type filenames: a list of strings (filenames)
        @param readNow: set to True to add the words from the given files
                        immediately to the reader
        @type readNow: boolean
        """
    ...
    def char2ind(self, char):
        ...
        @type char: character
        @rtype: integer
        @return: index of the mapped character
        """
        if not self.chrMap:
            self._createChrMap()
    ...
    def getCharMapSize(self):
        '''
        @return: number of different accepted characters
        @rtype: integer
        '''
        if not self.chrMap:
            _createChrMap()
    ...
    def ind2char(self, index):
        ...
        @param index: the mapped index
        @type index: integer
        @rtype: character
        @return: character matching the mapped index
        """
        if not self.chrMap:
            self._createChrMap()
    ...
    def sanitize(self, word):
        ...
        @type word: string
        @return: the same word sanitized, or empty string if the word is bad
        @rtype: string
        """
