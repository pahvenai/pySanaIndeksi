...
from Support.LinkedList import LinkedList # Used as a queue
...
##################
    ...
    @property
    def status(self):
        """ Is 'ok' (string) if current search phrase is ok """
        return self._status
...
######################
    ...
    def search(self, searchPhrase=None, printPretty = False, maxHitPrint=None,
        ...
        @param searchPhrase: Use this string as a search phrase
        @param printPretty:  Print out hits as pretty as one can
        @param maxHitPrint:  If you find many terms, print them out less pretty.
                             This value tells you how many is 'many'.
        @param returnCount:  If set to True, return only the number of hits
        @return: Returns hits as a set of tuples
        """
        if maxHitPrint:
    ...
    def randomWord(self, count = 1):
        ...
        @param count: Set to larger than 1 to get more words
        @return: One random word or a list of random words
        """
